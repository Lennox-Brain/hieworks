             ...
             <div>
                ...
                <div class="shadow-md">
                   <div class="tab w-full overflow-hidden border-t">
                      ...
                      <label class="block p-5 leading-normal cursor-pointer tab-heading text-base md:text-lg font-bold" for="tab-single-one">What is hieworks ?</label>
                   ...
                   <div class="tab w-full overflow-hidden border-t">
                      ...
                      <label class="block p-5 leading-normal cursor-pointer tab-heading text-base md:text-lg font-bold" for="tab-single-two">How do i list my job vacancy on hieworks ?</label>
                      <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-indigo-500 leading-normal">
                         <p class="p-5 font-bold">
                   ...
                   <div class="tab w-full overflow-hidden border-t">
                      ...
                      <label class="block p-5 leading-normal cursor-pointer tab-heading text-base md:text-lg font-bold" for="tab-single-three">Does listing of job vacancy requires payment ?</label>
                      <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-indigo-500 leading-normal">
                         <p class="p-5 font-bold">
                   ...
                   <div class="tab w-full overflow-hidden border-t">
                    ...
                    <label class="block p-5 leading-normal cursor-pointer tab-heading text-base md:text-lg font-bold" for="tab-single-four">How do i apply for a job on hieworks ?</label>
                    <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-indigo-500 leading-normal">
                       <p class="p-5 font-bold">
                           Click on the job you want to apply to, after carefully reading the job details, scroll to the bottom to find 
                           the more info button, click on it to see the application details. Note that some recruiters may disable the
                           option that allows you to apply for the job through the hieworks portal so you may have to submit your application
                 ...
                 <div class="tab w-full overflow-hidden border-t">
                    ...
                    <label class="block p-5 leading-normal cursor-pointer tab-heading text-base md:text-lg font-bold" for="tab-single-five">Is there a limit to the number of jobs i can apply ?</label>
                    <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-indigo-500 leading-normal">
                       <p class="p-5 font-bold">
                 ...
                 <div class="tab w-full overflow-hidden border-t">
                    ...
                    <label class="block p-5 leading-normal cursor-pointer tab-heading text-base md:text-lg font-bold" for="tab-single-six">How do i get a list of applicant for my job post?</label>
                    <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-indigo-500 leading-normal">
                       <p class="p-5 font-bold">
                 ...
                 <div class="tab w-full overflow-hidden border-t">
                    ...
                    <label class="block p-5 leading-normal cursor-pointer tab-heading text-base md:text-lg font-bold" for="tab-single-seven">Can i enable or disable email notifications when applicants apply for my job post ?</label>
                    <div class="tab-content overflow-hidden border-l-2 bg-gray-100 border-indigo-500 leading-normal">
                       <p class="p-5 font-bold">
