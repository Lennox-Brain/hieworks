<div class="container mx-auto px-2 sm:px-0 my-4 py-3">
    <div class="search-container">
         <form method="GET" action="{{route('search')}}" class="flex justify-center">
            <input type="text" class="bg-gray-200 rounded-l-full w-full sm:w-1/3 p-2 focus:bg-white border text-gray-600" name="q" placeholder="Job Title, Location, Type or Category ">
            <button class="bg-purple-800 text-white p-2 rounded-r-full focus:outline-none">
