                              ...
                              {{-- @dump($job) --}}
                                 <form method="POST" action="{{route('update:jobpost')}}" class="border p-2 mt-4 w-full sm:w-4/5" x-data="utils()" enctype="multipart/form-data" id="postjobform">
                                    ...
                                    <div class="my-4 mx-2">
                                        ...
                                        <textarea placeholder="Full job description" rows="8" class="input text-left" name="job_description" id="description">{{old('job_description', $job->job_description)}}</textarea>
                                    </div>
                                    <div>
                                        @csrf
                                        @method('POST')
