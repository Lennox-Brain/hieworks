@extends('layouts.wireframe')
    @section('page-title', 'hieworks.com Register')
                    ...
                    <ul class="text-gray-700">
                        <li>
                            <div class="bg-white border rounded-full my-3 p-1 flex items-center">
                                ...
                                <span>Make unlimited job uploads</span>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="bg-white border rounded-full my-3 p-3 flex items-center">
                                ...
                                <span>Track employees applications</span>
                            </div>
                        </li>
                           ...
                           <form method="POST" action="{{route('signup')}}" autocomplete="off">
                               ...
                               <div class="block md:flex justify-start my-5">
                                  <div class="w-full my-3 md:my-0 md:mx-5">
                                    ...
                                    <textarea class="input" name="company_summary" maxlength="500" required placeholder="summary information about your company or business"></textarea>
                                </div>
                               </div>
