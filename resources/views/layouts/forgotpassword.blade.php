        ...
        <div class="page container mx-auto px-2 md:px-0 bg-white px-2 md:px-4 py-4 min-h-screen">
            <div class="p-2 md:p-10 md:w-3/5 mx-auto border">
                <div class="p-4 md:w-full lg:w-3/5 mx-auto">
                  ...
                  <form method="POST" action="{{route('passwordreset:link')}}" class="pt-6 pb-2 my-2" x-data={toggle:0}>
                    ...
                    <div class="mb-4">
                        ...
                        <input class="appearance-none border rounded w-full py-1 px-3 text-gray-600" id="email" type="email" value="{{old('email')}}" required name="email" placeholder="Email Address">
                    </div>
                    <div>
                        @csrf
                    </div>
