...
<head>
        ...
        <!--<![endif]-->
        <title>account password reset - hieworks.com</title>
        <!--[if !mso]><!-->
...
<body>
    <div class="container">
       <div style=" font-weight:bold">Hi there,</div>
             <h3 style="color:#553c9a">Confirm Password Reset</h3>
             This notification is on behalf of hieworks to let you know that the was a password reset request
             on your hieworks account.
             <div>
                 If this action was initiated by you, <a href="{{$link}}">click</a> on the link to complete the process
                 else you may ignore this message.
