    ...
    <div class="container">
       <div style=" font-weight:bold">Hi there,</div>
            ...
            <div style="text-align: center">
                <a href="https://hieworks.com?utm_source=email&utm_medium=email-newsletter" style="text-decoration: none;color:royalblue;font-weight:bold">hieworks.com&copy;{{date('Y')}}</a>
            </div>
